...
export class AssistantComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    combineLatest([this.numberOfFlagWords$, this.overallNumberOfWords$, this.reliableInfo$])
      ...
      .subscribe(([flagWords, overallNumber, reliableInfo]) => {
        ...
        this.formalStatus = this.calculator.calculateFormalStatus(this.formalityData);
        this.reliableStatus = this.calculator.calculateReliabilityStatus(reliableInfo);
    });
  }
